    ...
    <div class="flex flex-row gap-3">
        ...
        <div class="bg-white mt-3 basis-full rounded-md p-3 hidden lg:block">
            ...
            @foreach ($categories as $category)
                <div class="flex items-center mb-2">
                    <input type="radio" value="{{ $category->id }}" id="{{ $category->name }}" wire:model.live="subCategory"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        ...
        <div class="bg-white mt-3 basis-full rounded-md block lg:hidden">
            <select name="subCategory" class="w-full border-0 rounded-md" wire:model.live="subCategory" autocomplete="off">
