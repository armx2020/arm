<div class="flex flex-row rounded-lg bg-white h-36 md:h-64 p-2 sm:p-4 truncate relative">
    <a href="{{ route($entityShowRout, ['id' => $entity->id]) }}">
        <img class="h-32 w-32 md:h-56 md:w-56 rounded-lg object-cover"
    ...
    <div class="px-3 lg:px-5 flex flex-col max-w-48 flex-1 truncate">
        <div class="flex truncate">
            <a href="{{ route($entityShowRout, ['id' => $entity->id]) }}">
                <p class="mb-2 mt-2 sm:mt-0 text-xs md:text-base lg:text-xl font-bold leading-tight text-neutral-700 truncate">
