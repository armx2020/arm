        ...
        <div class="flex flex-col md:flex-row basis-full bg-white rounded-md p-3 lg:p-4">
            ...
            <div class="flex flex-col basis-1/5 flex-none">
                <img src="{{ isset($entity->image) ? asset('storage/' . $entity->image) : url('/image/groups.png') }}"
                    class="h-56 w-full rounded-2xl p-2 flex object-cover" alt="{{ $entity->name }}"></li>
            </div>
                                    ...
                                    <tbody>
                                        ...
                                        @if ($entity->web)
                                            <tr>
                                                ...
                                                <td class="whitespace-nowrap px-6 py-1 text-left">{{ $entity->web }}</td>
                                            </tr>
                                        @endif
                                        ...
                                        @if ($entity->phone)
                                            <tr>
                                                ...
                                                <td class="whitespace-nowrap px-6 py-1 text-left">{{ $entity->phone }}</td>
                                            </tr>
                                        @endif
                                        ...
                                        @if ($entity->whatsapp)
                                            <tr>
                                                ...
                                                <td class="whitespace-nowrap px-6 py-1 text-left">{{ $entity->whatsapp }}</td>
                                            </tr>
                                        @endif
                                        ...
                                        @if ($entity->telegram)
                                            <tr>
                                                ...
                                                <td class="whitespace-nowrap px-6 py-1 text-left">{{ $entity->telegram }}</td>
                                            </tr>
                                        @endif
                                        ...
                                        @if ($entity->viber)
                                            <tr>
                                                ...
                                                <td class="whitespace-nowrap px-6 py-1 text-left">{{ $entity->viber }}</td>
                                            </tr>
                                        @endif
                                        ...
                                        @if ($entity->instagram)
                                            <tr>
                                                ...
                                                <td class="whitespace-nowrap px-6 py-1 text-left"> {{ $entity->instagram }}</td>
                                            </tr>
                                        @endif
                                        ...
                                        @if ($entity->vkontakte)
                                            <tr>
                                                ...
                                                <td class="whitespace-nowrap px-6 py-1 text-left">{{ $entity->vkontakte }}</td>
                                            </tr>
                                        @endif
