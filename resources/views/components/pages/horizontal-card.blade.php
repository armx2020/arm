<div class="flex flex-col md:flex-row basis-full bg-white rounded-md p-1 lg:p-5">
    <div class="flex flex-col basis-1/5 flex-none" @if ($company->image !== null && $company->image1 !== null) id="slider" @endif>
        <ul>
    ...
    <div class="flex flex-col px-3 lg:px-10 sm:basis-full">
