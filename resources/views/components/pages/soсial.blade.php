    ...
    <p class="text-left pb-0">
        @if ($entity->viber)
            <a href="{{ $entity->viber }}" class="inline">
                <svg class="w-5 h-5 inline" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    enable-background="new 0 0 192 210.0428" id="viber" version="1.1" viewBox="0 0 192 210.0428"
                    xml:space="preserve">
                    <g>
                        <path
        ...
        @if ($entity->web)
            <a href="{{ $entity->web }}" class="inline">
                <svg class="w-5 h-5 inline" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" id="Layer_1"
                    viewBox="0 0 128 128">
                    <defs>
                        <style>
                            .cls-1 {
