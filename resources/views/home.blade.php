...
<section>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-rows-10 lg:grid-rows-3 gap-4 w-11/12 lg:w-10/12 mx-auto py-5 lg:py-10">
        <div class="bg-white rounded-xl h-32 md:h-42 lg:h-72 col-span-1 lg:col-span-2 row-span-1 lg:row-span-2">
            <div class="flex flex-row">
                <div class="flex flex-col text-left basis-2/3 lg:basis-1/2 p-3 lg:p-5">
                    <div class="my-1 lg:my-3 text-sm lg:text-2xl font-bold">{{ $group->name }}</div>
