...
<section>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-rows-10 lg:grid-rows-3 gap-4 w-10/12 mx-auto py-5 lg:py-10">
        <div class="bg-white rounded-xl p-2 h-32 md:h-42 lg:h-72 col-span-1 lg:col-span-2 row-span-1 lg:row-span-2">
        ...
        <div class="bg-blue-100 rounded-xl p-2 h-32 md:h-42 lg:h-full">
            <div class="flex flex-row">
                ...
                <div class="basis-1/2">
                    <img class="float-right h-5/6 m-1" src="{{ url('/image/banner7.png')}}" alt="banner">
                </div>
            </div>
        </div>
        <div class="bg-blue-100 rounded-xl p-2 h-32 md:h-42 lg:h-full">
