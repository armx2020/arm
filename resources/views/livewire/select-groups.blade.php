<div>
    <div class="flex flex-col lg:flex-row mx-auto">
        ...
        <div class="flex flex-col basis-full lg:basis-4/5 lg:m-3 my-3 lg:ml-5 min-h-screen" style="max-width: 80%">
            ...
            <div class="flex flex-nowrap gap-x-2 mb-3 overflow-x-scroll scrollhidden basis-full">
                        ...
                        <div class="px-3 md:px-6">
                            ...
                            <div class="relative">
                                <div class="text-left pb-0 block">
                                    ...
                                    @if($group->web)
                                    <a href="{{ $group->web }}" class="inline">
                                        <svg class="w-5 h-5 inline" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" id="Layer_1" viewBox="0 0 128 128">
                                            <defs>
                                                <style>
                                                    .cls-1 {
                                                        fill: #062b31;
