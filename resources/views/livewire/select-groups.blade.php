<div>
    <div class="flex flex-row w-11/12 mx-auto">
        <div class="flex flex-col basis-full lg:basis-1/5 m-5">
            <div class="bg-white rounded-md pb-3">
        ...
        <div class="flex basis-full lg:basis-4/5 m-5 min-h-screen">
            ...
            <div wire:loading.remove class="w-full">
                ...
                <div class="grid grid-cols-3 gap-5">
                    ...
                    <div class="block rounded-lg bg-white">
                        <a href="#!">
                            @if( $group->image == null )
                            <img class="rounded-full m-4" src="{{ url('/image/groups.png')}}" alt="" />
                            @else
                            <img class="max-w-xs rounded-full m-4" src="{{ asset( 'storage/'.$group->image) }}" alt="{{ $group->image }} avatar">
                            @endif
                        </a>
                        <div class="p-6">
                            <h5 class="mb-2 break-all text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-50">
                                {{ $group->name }}
                            </h5>
