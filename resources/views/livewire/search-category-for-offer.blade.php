<div class="py-6 px-4 max-w-7xl mx-auto rounded-t-lg">
    <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200">
        <div class="mb-3 w-full">
            ...
            @endif
            <div class="mb-4">
                <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">All categories for offers</h1>
            </div>
            <div class="sm:flex">
                <div class="hidden sm:flex items-center sm:divide-x sm:divide-gray-100 mb-3 sm:mb-0">
                    <form class="lg:pr-3" action="#" method="GET">
                        ...
                        <div class="mt-1 relative lg:w-64 xl:w-96">
                            <input type="text" wire:model="term" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Search for categories">
                        </div>
                    </form>
                </div>
                <div class="flex items-center space-x-2 sm:space-x-3 ml-auto">
                    <a href="{{ route('admin.offerCategory.create') }}" data-modal-toggle="add-user-modal" class="w-1/2 text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium inline-flex items-center justify-center rounded-lg text-sm px-3 py-2 text-center sm:w-auto">
                        ...
                        <table class="table-auto min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th scope="col" class="p-4 w-1/6 text-left text-xs font-medium text-gray-500 uppercase">
                                        Sort
                                    </th>
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 whitespace-nowrap space-x-2 w-1/6">
                                        <div class="flex flex-row justify-end">
                                            <a href="{{ route('admin.category.edit', ['category' => $category->id ]) }}" data-modal-toggle="user-modal" class="text-white mx-2 bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                                            ...
                                            <form action="{{ route('admin.category.destroy', ['groupCategory' => $category->id]) }}" method="post">
                                                @csrf
                                                @method('DELETE')
