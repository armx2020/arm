                ...
                <div class="hidden sm:flex items-center sm:divide-x sm:divide-gray-100 mb-3 sm:mb-0">
                    <form class="lg:pr-3" action="#" method="GET">
                        ...
                        <div class="mt-1 relative lg:w-64 xl:w-96">
                            <input type="text" wire:model="term" id="users-search" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Search for events">
                        </div>
                    </form>
                </div>
                <div class="flex items-center space-x-2 sm:space-x-3 ml-auto">
                    <a href="{{ route('admin.event.create') }}" data-modal-toggle="add-user-modal" class="w-1/2 text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium inline-flex items-center justify-center rounded-lg text-sm px-3 py-2 text-center sm:w-auto">
    ...
    <div wire:loading.remove>
        ...
        <div class="bg-white shadow p-4">
            <div class="flex items-center text-center">
                <h3 class="text-xl font-normal mx-auto">No events</h3>
            </div>
        </div>
        @else
                        ...
                        <table class="table-fixed min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 whitespace-nowrap space-x-2 text-right justify-items-end">
                                        <div class="flex flex-row">
                                            ...
                                            <form action="{{ route('admin.event.destroy', ['event' => $event->id]) }}" method="post">
                                                @csrf
                                                @method('DELETE')
