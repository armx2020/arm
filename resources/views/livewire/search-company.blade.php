        ...
        <div class="my-3 w-full">
            ...
            <div class="sm:flex justify-between">
                ...
                <div class="flex items-center space-x-2 sm:space-x-3">
                    <a href="{{ route('admin.company.create') }}" data-modal-toggle="add-user-modal"
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            @foreach ($selectedColumns as $column)
                                                <td class="p-4 whitespace-nowrap text-base text-center text-gray-900">
                                                    <a
                                                        href="{{ route('admin.company.edit', ['company' => $company->id]) }}">
                                                        {{ $company->$column }}
                                                    </a>
                                                </td>
                                            @endforeach
                                            <td class="p-4 whitespace-nowrap space-x-2 text-right w-1/6">
                                                <div class="flex flex-row justify-end">
                                                    <form
                                                        ...
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" data-modal-toggle="delete-company-modal"
