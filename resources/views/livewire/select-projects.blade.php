    ...
    <div class="flex flex-col lg:flex-row w-11/12 mx-auto">
        ...
        <div class="flex flex-col basis-full lg:basis-4/5 lg:m-3 my-3 lg:ml-5 min-h-screen">
            ...
            <div class="flex flex-nowrap gap-x-2 mb-3 overflow-x-scroll scrollhidden">
                <div class="flex-none py-2 px-3 rounded-md" id="select-area_2" @if($term==2) style="background-color: rgb(234 88 12);" @else style="background-color: white;color:black;" @endif>
                ...
                <div class="flex-none py-2 px-3 rounded-md" id="select-area_0" @if($term==0) style="background-color: rgb(234 88 12);" @else style="background-color: white;color:black;" @endif>
                ...
                <div class="flex-none py-2 px-3 rounded-md" id="select-area_1" @if($term==1) style="background-color: rgb(234 88 12);" @else style="background-color: white;color:black;" @endif>
