                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 lg:gap-5">
                        ...
                        <div class="block rounded-lg bg-white">
                            <a href="#!" class="">
                                ...
                                @else
                                <img class="max-w-xs h-48 rounded-lg my-2 mx-auto" src="{{ asset( 'storage/'.$company->logo) }}" alt="{{ $company->logo }} avatar">
                                @endif
                            </a>
                            <div class="p-6">
                                ...
                                <div>
                                    <p class="text-left pb-0">
                                        @if( $company->viber )
                                        <a href="{{ $offer->viber }}" class="inline">
