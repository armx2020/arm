                            ...
                            <div class="p-6 space-y-6">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="name"
                                            class="text-sm font-medium text-gray-900 block mb-2">Имя</label>
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <select name="user" id="user"
                                            ...
                                            @foreach ($users as $user)
                                                <option value="{{ $user->id }}" @selected($user->id == $entity->user_id)>
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <select name="city"
                                            ...
                                            @foreach ($cities as $city)
                                                <option value="{{ $city->id }}" @selected($city->id == $entity->city_id)>
                                                    {{ $city->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
