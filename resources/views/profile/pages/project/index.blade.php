...
<div class="flex flex-col lg:flex-row w-11/12 mx-auto my-10">
            ...
            <div class="block rounded-lg bg-white h-80">
                ...
                <div class="px-6">
                    ...
                    <div class="my-1 break-all text-base text-right">
                        <a href="{{ route('myproject.edit', ['id' => $project->id]) }}" class="inline border-2 hover:border-yellow-400 border-yellow-100 bg-yellow-100 hover:bg-yellow-400 rounded-md py-2 pl-2 pr-1 my-1" title="редактировать">
                        ...
                        <form method="post" action="{{ route('myproject.destroy', ['id' => $project->id]) }}" class="inline">
                            @csrf
                            @method('delete')
    ...
    <div id="add_project_form" class="hidden fixed inset-0 px-4 min-h-screen sm:px-0 z-50" focusable>
        ...
        <div class="my-16 mx-auto opacity-100 translate-y-0 sm:scale-100 bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full md:max-w-md lg:max-w-lg ">
            <form method="post" action="{{ route('myproject.store') }}" class="p-6" enctype="multipart/form-data">
                @csrf
                ...
                <div class="my-2">
                    ...
                    <x-text-input id="donations_need" name="donations_need" type="number" class="mt-1 block w-full" :value="old('donations_need')" autofocus />
