    ...
    <div class="flex flex-col basis-full lg:basis-4/5 lg:m-3 my-3 lg:ml-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 lg:gap-5 w-full">
            ...
            <div class="block rounded-lg bg-white h-80">
                ...
                <div class="px-6">
                    <h5 class="mb-3 break-words text-lg font-medium leading-tight text-neutral-800">
                        {{ $event->name }} ({{ Auth::user()->firstname }})
                    </h5>
                    <hr class="my-2">
                    <div class="my-4 break-all text-base text-right">
                        <p class="mx-3 inline">{{ $event->date_to_start}}</p>
            ...
            <a href="{{ route('myevents.create') }}" class="h-80 items-center justify-center flex rounded-lg border-dashed border-2 border-indigo-600 hover:bg-white">
                <div class="flex flex-col w-full items-center">
                    <div class="text-9xl text-indigo-600 flex mx-auto leading-none">+</div>
                    <div class="text-xl text-indigo-600 flex mx-auto uppercase">Добавить мероприятие</div>
                </div>
            </a>
