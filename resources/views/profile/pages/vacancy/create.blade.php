        ...
        <div class="flex flex-col basis-full lg:basis-4/5 lg:m-3 my-3 lg:ml-5">
            <div class="flex flex-col basis-full">
                <div class="flex flex-col md:flex-row basis-full bg-white rounded-md p-2 lg:p-10 relative">
                    <form method="post" action="{{ route('myvacancies.store') }}" class="w-full" enctype="multipart/form-data">
                        @csrf

                        <div class="w-full">
                            <h2 class="text-xl">Добавить вакансию</h2>
                        ...
                        <div class="my-2">
                            ...
                            <select name="vacancy_city" class="w-full" style="border-color: rgb(209 213 219); width:100%"
                                id="vacancy_city">
