    ...
    <div class="flex flex-col basis-full lg:basis-4/5 lg:m-3 my-3 lg:ml-5">
        <div class="flex flex-col basis-full">
            <div class="flex flex-col md:flex-row basis-full bg-white rounded-md p-1 lg:p-10 relative">
                <form method="post" action="{{ route('myresume.update', ['id' => $resume->id]) }}" class="w-full" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    ...
                    <div class="my-2">
                        ...
                        <x-text-input id="price" name="price" type="number" class="mt-1 block w-full" value="{{ $resume->price }}" autofocus />
