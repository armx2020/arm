        ...
        <div class="flex flex-col basis-full">
            <div class="flex flex-col md:flex-row basis-full bg-white rounded-md p-1 lg:p-10 relative">
                ...
                <div class="flex flex-col px-3 lg:px-10 basis-3/4">
                    <h3 class="text-left text-xl lg:text-2xl mx-4">{{ $resume->name }} ({{$resume->parent->firstname}})</h3>
                    <p class="text-left text-md mx-4 my-1 text-gray-600">{{ $resume->city->name }} {{ $resume->address }}
                    </p>
                    <p class="text-left text-sm mx-4 my-1 text-gray-500 break-all">{{ $resume->description }}</p>
                    <hr class="mt-3 mb-3">
                    <div class="flow-root mb-3 break-words">

                        @if($resume->parent->phone)
                        <div class="inline">
                        ...
                        <div class="inline m-2">
                            ...
                            {{ $resume->parent->whatsapp }}
                        </div>
                        @endif

                        @if( $resume->parent->instagram )
                        <div class="inline m-2">
                            ...
                            {{ $resume->parent->instagram }}
                        </div>
                        @endif

                        @if( $resume->parent->vkontakte )
                        <div class="inline m-2">
                            ...
                            {{ $resume->parent->vkontakte }}
                        </div>
                        @endif

                        @if( $resume->parent->telegram )
                        <div class="inline m-2">
