...
@section('title')
    <title>Все армяне - Мои сообщества</title>
@endsection

@section('meta')
    <meta name="robots" content="noindex, nofollow" />
    <meta name="description" content="Все армяне - изменить сообщество">
@endsection
        ...
        <div class="flex flex-col basis-full lg:basis-4/5 lg:m-3 my-3 lg:ml-5">
            <div class="flex flex-col basis-full">
                <div class="flex flex-col md:flex-row basis-full bg-white rounded-md p-1 lg:p-5 relative">
                    <form id="card-form" method="post" action="{{ route('mygroups.update', ['mygroup' => $entity->id]) }}" class="w-full"
