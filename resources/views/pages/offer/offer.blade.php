...
<section>
    <div class="flex flex-col w-11/12 mx-auto my-6 lg:my-8">
        <div class="flex flex-col md:flex-row basis-full bg-white rounded-md p-1 lg:p-5 relative">
            <div class="flex flex-col basis-1/5" @if( $offer->image !== null && $offer->image1 !== null)
                id="slider"
                @endif
                >
                <ul>
                    ...
                    @else
                    <li><img src="{{ asset( 'storage/'.$offer->image) }}" class="h-56 w-full rounded-2xl p-2 flex object-cover" alt="image"></li>
                    @endif

                    @if($offer->image1)
                    <li><img src="{{ asset( 'storage/'.$offer->image1) }}" class="h-56 w-full rounded-2xl p-2 flex object-cover" alt="image1"></li>
                    @endif

                    @if($offer->image2)
                    <li><img src="{{ asset( 'storage/'.$offer->image2) }}" class="h-56 w-full rounded-2xl p-2 flex object-cover" alt="image2"></li>
                    @endif

                    @if($offer->image3)
                    <li><img src="{{ asset( 'storage/'.$offer->image3) }}" class="h-56 w-full rounded-2xl p-2 flex object-cover" alt="image3"></li>
                    @endif

                    @if($offer->image4)
                    <li><img src="{{ asset( 'storage/'.$offer->image4) }}" class="h-56 w-full rounded-2xl p-2 flex object-cover" alt="image4"></li>
                    @endif
                </ul>
            ...
            <div class="flex flex-col px-3 lg:px-10 basis-3/4">
                <h3 class="text-left text-xl lg:text-2xl mx-4">{{ $offer->name }} ({{ $offer->company->name}})</h1>
                    ...
                    <div class="flow-root mb-3 break-words">
                        ...
                        @if($offer->phone)
                        <div class="inline">
                            <svg class="w-5 h-5 inline ml-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
                        ...
                        @if($offer->viber)
                        <div class="inline">
                            <svg class="w-5 h-5 inline ml-4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 192 210.0428" id="viber" version="1.1" viewBox="0 0 192 210.0428" xml:space="preserve">
                                <g>
                        ...
                        @if( $offer->web )
                        <div class="inline">
                            <svg class="w-5 h-5 inline ml-4" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" id="Layer_1" viewBox="0 0 128 128">
                                <defs>
                                    <style>
                                        .cls-1 {
                                            fill: #062b31;
                        ...
                        @if( $offer->whatsapp )
                        <div class="inline">
                            <svg class="w-5 h-5 inline ml-4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="56.693px" id="Layer_1" style="enable-background:new 0 0 56.693 56.693;" version="1.1" viewBox="0 0 56.693 56.693" width="56.693px" xml:space="preserve">
                                <style type="text/css">
                                    .st0 {
                                        fill-rule: evenodd;
                                        clip-rule: evenodd;
                        ...
                        @if( $offer->instagram )
                        <div class="inline">
                            <svg class="w-5 h-5 inline ml-4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 56.7 56.7" enable-background="new 0 0 56.7 56.7" xml:space="preserve">
                                <g>
                        ...
                        @if( $offer->vkontakte )
                        <div class="inline">
                            <svg class="w-6 h-6 inline ml-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                <title />
                        ...
                        @if( $offer->telegram )
                        <div class="inline">
                            <svg class="w-6 h-6 inline ml-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <g>
        ...
        <div class="flex flex-col basis-full my-5">
            <div class="w-full text-left p-4 mt-8">
                <div class="flex items-center text-left justify-left">
                    <h3 class="text-2xl font-normal">Другие товары этой компании</h3>
                </div>
            </div>
            ...
            <div class="w-full lg:w-11/12 mx-auto py-3 lg:py-6 px-6 lg:px-0">
                {{ $recommendations->onEachSide(2)->links()}}
            </div>
        </div>
        @endif
