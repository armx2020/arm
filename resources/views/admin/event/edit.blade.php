                        ...
                        <div class="bg-white rounded-lg relative">
                            ...
                            <div class="p-6 space-y-6">
                                <form method="POST" enctype="multipart/form-data"
                                    action="{{ route('admin.event.update', ['event' => $event->id]) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <select name="parent" id="parent"
                                                ...
                                                @if ($event->parent_type == 'App\Models\User')
                                                    <option selected="true" disabled="disabled">old: User
                                                        ({{ $event->parent->firstname }} {{ $event->parent->email }})
                                                    </option>
                                                @elseif ($event->parent_type == 'App\Models\Group')
                                                    <option selected="true" disabled="disabled">old: Group
                                                        ({{ $event->parent->name }})</option>
                                                @elseif ($event->parent_type == 'App\Models\Company')
                                                    <option selected="true" disabled="disabled">old: Company
                                                        ({{ $event->parent->name }})</option>
                                                @else
                                        ...
                                        <div class="col-span-6 hidden" id="User">
                                            <label for="user"
                                                class="text-sm font-medium text-gray-900 block mb-2">User</label>
                                            <select name="user"
                                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5">
                                        ...
                                        <div class="col-span-6 hidden" id="Group">
                                            <label for="group"
                                                class="text-sm font-medium text-gray-900 block mb-2">Group</label>
                                            <select name="group"
                                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5">
