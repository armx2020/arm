                                    ...
                                    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.event.store') }}">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <input type="date" name="date_to_start" id="date_to_start" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" :value="old('date_to_start')" required autofocus>
                                        ...
                                        <div class="items-center p-6 border-gray-200 rounded-b">
                                            <button class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="submit">Add event</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
