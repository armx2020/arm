...
<div class="my-4 w-full grid grid-cols-1 gap-4">
    ...
    <div class="bg-white shadow rounded-lg p-3">
        <div class="flex flex-col items-center">
            ...
            <a href="{{ route('admin.company.show', ['company' => $project->parent->id ]) }}" class=" text-lg p-1 m-1  rounded-md text-gray-500 bg-green-200">
                {{ $project->parent->name }}
            </a>
        </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg p-3">
        <div class="flex flex-col items-center">
            ...
            <a href="{{ route('admin.group.show', ['group' => $project->parent->id ]) }}" class=" text-lg p-1 m-1  rounded-md text-gray-500 bg-green-200">
                {{ $project->parent->name }}
            </a>
        </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg p-3">
        <div class="flex flex-col items-center">
            ...
            <a href="{{ route('admin.user.show', ['user' => $project->parent->id ]) }}" class=" text-lg p-1 m-1  rounded-md text-gray-500 bg-green-200">
                {{ $project->parent->name }}
            </a>
        </div>
    </div>
