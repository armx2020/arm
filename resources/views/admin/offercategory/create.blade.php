                                    ...
                                    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.offerCategory.store') }}">
                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="items-center p-6 border-gray-200 rounded-b">
                                                <button class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="submit">Add offer</button>
                                            </div>
                                    </form>
                                </div>
                            </div>
