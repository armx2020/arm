                            ...
                            <div class="bg-white rounded-lg relative">
                                <div class="flex items-start p-5 border-b rounded-t m-1 md:m-3">
                                    <div class="flex items-center mb-4">
                                        <img class="h-20 w-20 rounded-full m-4" src="{{ url('/image/company.png')}}" alt="avatar">
                                    ...
                                    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.offer.store') }}">
                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <input type="tel" name="phone" id="phone" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" :value="old('phone')" required autocomplete="phone">
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <input type="text" name="unit_of_price" id="unit_of_price" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" :value="old('unit_of_price')" required autocomplete="unit_of_price">
