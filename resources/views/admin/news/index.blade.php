                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-100">
                                    <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                        ...
                                        @if( $new->image == null)
                                        <img class="h-10 w-10 rounded-full m-4" src="{{ url('/image/company.png')}}" alt="{{ $new->name }} image">
                                        @else
                                        <img class="h-10 w-10 rounded-full m-4" src="{{ asset( 'storage/'.$new->image) }}" alt="{{ $new->name }} avatar">
                                        @endif
