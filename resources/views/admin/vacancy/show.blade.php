                        ...
                        <table class="table-fixed min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th scope="col" class="w-1/4 p-4 text-left text-xs font-medium text-gray-500 uppercase">
                                        City
                                    </th>
...
<div class="my-4 w-full grid grid-cols-1 gap-4">
    ...
    <div class="bg-white shadow rounded-lg p-3">
        <div class="flex flex-col items-center">
            ...
            <a href="{{ route('admin.company.show', ['company' => $vacancy->parent->id ]) }}" class=" text-lg p-1 m-1  rounded-md text-gray-500 bg-green-200">
                {{ $vacancy->parent->name }}
            </a>
        </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg p-3">
        <div class="flex flex-col items-center">
            ...
            <a href="{{ route('admin.groups.show', ['group' => $vacancy->parent->id ]) }}" class=" text-lg p-1 m-1  rounded-md text-gray-500 bg-green-200">
                {{ $vacancy->parent->name }}
            </a>
        </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg p-3">
        <div class="flex flex-col items-center">
            ...
            <a href="{{ route('admin.user.show', ['user' => $vacancy->parent->id ]) }}" class=" text-lg p-1 m-1  rounded-md text-gray-500 bg-green-200">
                {{ $vacancy->parent->firstname }} {{ $vacancy->parent->lastname }}
            </a>
        </div>
    </div>
    @break
