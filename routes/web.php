...
Route::get('/jobs', [EntityController::class, 'jobs'])->name('jobs.index');
...
Route::get('/jobs/{category}', [EntityWithCategoryController::class, 'communities'])->name('jobs.category.index');
